...
myheading1='Callbacks'
tabtitle = 'xkcd'
list_of_options=['Lemond 8', 'correlation', 'git commit', 'scatterplot']
list_of_images=['lemond_8.png', 'correlation.png', 'gitcommit.jpg', 'scatterplot.png', 'good_code.png']
sourceurl = 'https://xkcd.com/'
githublink = 'https://github.com/amakarewycz/203-radio-callbacks'
